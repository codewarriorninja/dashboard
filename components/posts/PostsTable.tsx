...
const PostsTable = ({limit, title}:PostTableProps) => {
    //Sort posts in des order based on date
            ...
            <TableBody>
                {filteredPosts.map((post) => (
                    <TableRow key={post.id}>
                      ...
                      <TableCell className='hidden md:table-cell whitespace-nowrap'>{post.author}</TableCell>
                      <TableCell className='hidden md:table-cell text-right whitespace-nowrap'>{post.date}</TableCell>
